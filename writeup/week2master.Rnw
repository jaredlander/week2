...
opts_chunk$set(background='#ffffff')                 #% background color of code chunks.
...
opts_chunk$set(comment=NA, prompt=TRUE)             #% Whether to use prompts or comments
...
% bulk of the book
%\mainmatter
<<dist-funcs-section,child="distFuncs/distFuncs.Rnw">>=
@
