```{r intro-options,include=FALSE}
set_parent('../master.Rmd')
...
Here we compare the results of three quantitative indicators from the entire sample of that household surveys to smaller samples to determine an optimal sampling strategy for similar events in the future.
