...
```{r VillDist,fig=TRUE,echo=TRUE,fig.path="figures/",out.width='45%',fig.cap="Distribution of villages within Tehsils within the four Provinces.",fig.scap="Distribution of villages within Tehsils",fig.align='center'}
head(vills)
